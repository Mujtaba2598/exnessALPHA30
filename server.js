...
console.log('🕋 100% HALAL EXNESS TRADING BOT - REAL WORKING');
...
async function fetchRealBalance(accountId) {
    try {
        ...
        console.log('📊 REAL account data:', JSON.stringify(accountInfo, null, 2));
        ...
        return { balance, currency, equity, margin, freeMargin, full: accountInfo };
    } catch (error) {
...
class HalalTradingEngine {
    ...
    async executeTrade(symbol, side, aiDecision) {
        ...
        try {
            ...
            if (balance < 1) {
                console.log(`⚠️ Balance is 0. Cannot trade.`);
                return;
            }
...
app.listen(PORT, '0.0.0.0', () => {
    console.log(`\n🕋 100% HALAL EXNESS TRADING BOT - REAL WORKING`);
